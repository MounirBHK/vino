    ...
    return (
        <div className="Carte-une-bouteille">
                <div className="couleur">
                    <p className={bouteilleReceived.type}><CircleIcon sx={{ fontSize: 150, top: 250, left: 200 }} /></p>
                    <p className={bouteilleReceived.type}><CircleIcon sx={{ fontSize: 50, top: 300, left: 100 }} /></p>
                    <p className={bouteilleReceived.type}><CircleIcon sx={{ fontSize: 250, top: 150, left: 55 }} /></p>
                    <p className={bouteilleReceived.type}><CircleIcon sx={{ fontSize: 200, top: 75, left: 110 }} /></p>
                    <p className={bouteilleReceived.type}><CircleIcon sx={{ fontSize: 75, top: 180, left: 30 }} /></p>
                </div>
                <div className="nom">
