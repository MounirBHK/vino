...
function FormModifierBouteille({ bouteille }) {
    ...
    const handleSubmit = (e) => {
        ...
        putModifCellierBout(bouteille).then((response) => {
            ...
            navigate(`/dashboard/celliers/${idCellier}/${idBouteille}`, {state:bouteille} );
        });
    };
    ...
    return (
        <React.Fragment>
            ...
            <h3 className="modifierBoutCell-subtitle">Cellier : {bouteille.id_cellier}</h3>
            <h3 className="modifierBoutCell-subtitle">Bouteille : {bouteille.id_bouteille}</h3>
